...
async def _seed_default_dataset(dataset_name: str) -> dict:
    ...
    explanation_file_path_quantum = os.path.join(
        pathlib.Path(__file__).parent.parent, "test_data/Quantum_computers.txt"
    )
...
async def e2e_state():
    ...
    triplets = {
        ...
        "graph_completion_context_extension": await GraphCompletionContextExtensionRetriever().get_triplets(  # noqa: E501
            query=query
        ),
